...
try:
    ...
    from scripts.formatters import (
        prepend_disclaimer, extract_response_data,
        format_open_orders, format_order_detail, format_order_history,
    )
    from scripts.guards import validate_client_order_id
except ImportError:
    ...
    from guards import validate_client_order_id
