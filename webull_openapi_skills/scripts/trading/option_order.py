...
try:
    ...
    from scripts.guards import validate_client_order_id, validate_option_order, validate_option_strategy_order
    ...
    from guards import validate_client_order_id, validate_option_order, validate_option_strategy_order
